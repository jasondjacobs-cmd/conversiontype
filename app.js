const key='conversiontype.consent.v1',dialog=document.querySelector('#privacy');
...
const definitions={
 ...
 'US customary cup':{label:'US customary cup',text:'A volume measure equal to 8 US fluid ounces, 16 US tablespoons, or about 236.588 milliliters.'},
 'metric cup':{label:'Metric cup',text:'A volume measure equal to 250 milliliters.'},
 'fluid ounce':{label:'Fluid ounce',text:'A US customary unit of volume. It is not the same as an ounce by weight.'},
 'ounce by weight':{label:'Ounce by weight',text:'A unit of mass equal to exactly 28.349523125 grams.'},
 'tablespoon':{label:'Tablespoon',text:'A cooking volume measure equal to 3 US teaspoons or one-sixteenth of a US customary cup.'},
 'teaspoon':{label:'Teaspoon',text:'A small cooking volume measure equal to one-third of a US tablespoon.'},
 'milliliter':{label:'Milliliter',text:'A metric unit of volume equal to one thousandth of a liter.'},
 'ingredient density':{label:'Ingredient density',text:'The mass of an ingredient for a given volume. Different densities make grams-to-cups conversions ingredient-specific.'},
 'butter stick':{label:'Butter stick',text:'A US package measure for butter equal to 4 ounces by weight, 8 tablespoons, or one-half US cup.'},
 'weight ounces':{label:'Ounces by weight',text:'Ounces by weight measure mass. One avoirdupois ounce equals exactly 28.349523125 grams.'},
 'densities':{label:'Ingredient density',text:'The mass of an ingredient for a given volume. Different densities make grams-to-cups conversions ingredient-specific.'},
 'stick of butter':{label:'Butter stick',text:'A US package measure equal to 4 ounces by weight, 8 tablespoons, or one-half US cup.'},
 'cup':{label:'Cup',text:'A cooking measure of volume. Its exact size depends on the measurement standard.'},
