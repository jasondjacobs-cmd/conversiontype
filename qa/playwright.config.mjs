...
export default defineConfig({
  testDir:'.',
  testMatch:['conversiontype-production.spec.mjs','definition-bubbles-v1.spec.mjs','unit-conversion-v1.spec.mjs','date-time-v1.spec.mjs','cooking-conversion-v1.spec.mjs','ui-foundation-v1.spec.mjs','financial-calculators-v1.spec.mjs'],
  timeout:30000,
  expect:{timeout:7000},
  fullyParallel:false,
  retries:1,
